...
#  Created on Wed Apr 27 14:20:37 2022                
#                                                     
#######################################################
...
set init_verilog ISE_syn.v
set init_mmmc_file mmmc.view
set init_top_cell ISE
...
place_design
checkPlace ISE.checkPlace
setDrawView place
fit
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix ISE_preCTS -outDir timingReports
...
set_ccopt_property clock_period -pin clk 50
...
ccopt_design
saveIoFile -byOrder -temp ISE.io
loadIoFile ISE.io
setDrawView place
saveDesign cts.enc
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix ISE_postCTS -outDir timingReports
setOptMode -fixCap true -fixTran true -fixFanoutLoad true
optDesign -postCTS
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -hold -pathReports -slackReports -numPaths 50 -prefix ISE_postCTS -outDir timingReports
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix ISE_postRoute -outDir timingReports
setAnalysisMode -analysisType onChipVariation
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix ISE_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix ISE_postRoute -outDir timingReports
...
verifyGeometry
setVerifyGeometryMode -area { 0 0 0 0 }
verifyProcessAntenna -report ISE.antenna.rpt -error 1000
saveDesign chip.enc
saveNetlist ISE_pr.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf ISE_pr.sdf
streamOut ISE.gds -mapFile streamOut.map -libName DesignLib -units 1000 -mode ALL
